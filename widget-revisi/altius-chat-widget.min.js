...
function generateStyles() {
  return `
        ...
        .chat-toggle {
            width: 60px;
            height: 60px;
            background: linear-gradient(135deg, #4f8ca5 0%, #7fd8c2 100%);
            border-radius: 50%;
            display: flex;
            align-items: center;
            justify-content: center;
            cursor: pointer;
            box-shadow: 0 4px 20px rgba(79, 140, 165, 0.18);
        ...
        .chat-toggle:hover {
            transform: scale(1.1);
            box-shadow: 0 6px 25px rgba(79, 140, 165, 0.28);
        }
      ...
      height: ${CONFIG.CONTAINER_HEIGHT};
            background: #f4f8fb;
            border-radius: 12px;
            box-shadow: 0 10px 40px rgba(79, 140, 165, 0.10);
            display: none;
        ...
        .chat-close:hover {
            background: rgba(127, 216, 194, 0.12);
        }
        ...
        .message-text code {
            background: rgba(79, 140, 165, 0.08);
            padding: 2px 4px;
            border-radius: 3px;
        ...
        .bot-message .message-text {
            ...
            box-shadow: 0 1px 2px rgba(79, 140, 165, 0.05);
        }
